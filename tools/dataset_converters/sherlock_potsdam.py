...
def parse_args():
    ...
    parser.add_argument('--dataset_path', help='potsdam folder path', default='/home/wyuan/data/BEDataset/potsdam')
    parser.add_argument('--tmp_dir', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir', help='output path', default='/home/wyuan/data/BEDataset/potsdam_Bymmseg')
    parser.add_argument(
        '--clip_size',
        type=int,
